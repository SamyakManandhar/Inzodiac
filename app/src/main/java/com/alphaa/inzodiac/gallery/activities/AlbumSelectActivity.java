...
import com.alphaa.inzodiac.gallery.adapters.CustomAlbumSelectAdapter;
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.e(TAG, "onActivityResult: 111111111 " );
...
//            setResult(RESULT_OK, data);
            ...
            Intent intent = new Intent(this, AboutSelfActivity.class);
