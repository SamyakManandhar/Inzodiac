...
public class LuckyNumberAdapter extends  RecyclerView.Adapter<LuckyNumberAdapter.Viewhlder> {
    ...
    public Viewhlder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View view = LayoutInflater.from(parent.getContext()).inflate( R.layout.item_lucky_number, parent, false);
        return new Viewhlder(view);
    }

    public LuckyNumberAdapter(Context context, List<String> list) {
