...
public class CitySpinnerAdapter extends ArrayAdapter<CityResponse.DataItem> {


    public CitySpinnerAdapter(Context context,
                              ArrayList<CityResponse.DataItem> algorithmList) {
    ...
    private View initView(int position, View convertView,
        ...
        CityResponse.DataItem currentItem = getItem(position);
