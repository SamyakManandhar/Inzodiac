...
public class CountrySpinnerAdapter extends ArrayAdapter<CountryResponse.DataItem> {


    public CountrySpinnerAdapter(Context context,
                                 ArrayList<CountryResponse.DataItem> algorithmList) {
    ...
    private View initView(int position, View convertView,
        ...
        CountryResponse.DataItem currentItem = getItem(position);
