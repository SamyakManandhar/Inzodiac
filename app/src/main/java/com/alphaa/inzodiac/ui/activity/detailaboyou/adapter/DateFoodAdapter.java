...
public class DateFoodAdapter extends  RecyclerView.Adapter<DateFoodAdapter.Viewhlder> {

    String TAG = getClass().getSimpleName();

    Context context;
    ArrayList<DateFoodModel>list;
    Listener1 listener1;
    ...
    public DateFoodAdapter(Context context, ArrayList<DateFoodModel> list, Listener1 listener1) {
    ...
    public void onBindViewHolder(@NonNull Viewhlder holder, int position) {
        DateFoodModel s = list.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (getAdapterPosition() != -1) {
                        ...
                        DateFoodModel s = list.get(getAdapterPosition());
