...
public class PetsAdapter extends  RecyclerView.Adapter<PetsAdapter.Viewhlder> {

    String TAG = getClass().getSimpleName();

    Context context;
    ArrayList<PetsModel>list;
    Listener1 listener1;
    ...
    public PetsAdapter(Context context, ArrayList<PetsModel> list, Listener1 listener1) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (getAdapterPosition() != -1) {
                        ...
                        PetsModel s = list.get(getAdapterPosition());
