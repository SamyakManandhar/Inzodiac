...
public class MyWorkAdapter extends  RecyclerView.Adapter<MyWorkAdapter.Viewhlder> {
    ...
    public MyWorkAdapter(Context context, ArrayList<MyWorkModel> list, Listener1 listener1) {
    ...
    public void onBindViewHolder(@NonNull Viewhlder holder, int position) {
        MyWorkModel s = list.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (getAdapterPosition() != -1) {
                        ...
                        MyWorkModel s = list.get(getAdapterPosition());
