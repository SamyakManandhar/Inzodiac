...
public class EthnicityAdapter extends  RecyclerView.Adapter<EthnicityAdapter.Viewhlder> {

    String TAG = getClass().getSimpleName();

    Context context;
    ArrayList<EthnicityModel>list;
    Listener1 listener1;
    ...
    public EthnicityAdapter(Context context, ArrayList<EthnicityModel> list,Listener1 listener1) {
    ...
    public void onBindViewHolder(@NonNull Viewhlder holder, int position) {
        EthnicityModel s = list.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (getAdapterPosition() != -1) {
                        ...
                        EthnicityModel s = list.get(getAdapterPosition());
