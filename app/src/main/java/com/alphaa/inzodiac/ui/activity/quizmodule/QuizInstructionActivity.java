...
public class QuizInstructionActivity extends BaseActivity implements View.OnClickListener , ApiCallBackInterFace.AboutInfoCallback {
    String TAG = getClass().getSimpleName();

    ActivityQuizInstructionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_quiz_instruction);
    ...
    public void onAboutInfoResponse(String s) {
        Intent intent = new Intent(QuizInstructionActivity.this, TabActivity.class);
        startActivity(intent);
